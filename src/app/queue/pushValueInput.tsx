...
export default function InputValue({ enqueueValueStr, setEnqueueValueStr, setEnqueueInputHidden, enqueue }: prop) {
    ...
    return (
        <div className="input" style={{ background:"transparent" }}>
            <input type="number" id="stackSize" placeholder="請輸入數字" value={enqueueValueStr} onChange={(e) => onChange(e.target.value)} />
