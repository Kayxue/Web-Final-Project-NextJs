...
export default function DeleteInput({ deleteIndex, setDeleteIndex, setDeleteInputHidden, deleteVal }: prop) {
    ...
    return (
        <div className="input" style={{ background: "transparent" }}>
            <input type="number" id="stackSize" placeholder="請輸入要刪除元素的位置" value={deleteIndex} onChange={(e) => onChange(e.target.value)} />
