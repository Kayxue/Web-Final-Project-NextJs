...
export default function assignSizeInput({ arraySize, setArraySize, setAssignInputHidden, assignSize }: prop) {
    ...
    return (
        <div className="input" style={{ background: "transparent" }}>
            <input type="number" id="stackSize" placeholder="請輸入1~10之間的數字" value={arraySize} onChange={(e) => onChange(e.target.value)} />
