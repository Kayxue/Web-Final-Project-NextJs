...
export default function SearchInput({ searchInddex, setSearchIndex, setSearchInputHidden, searchValue}: prop) {
    ...
    return (
        <div className="input" style={{ background: "transparent" }}>
            <input type="number" id="stackSize" placeholder="請輸入位置" value={searchInddex} onChange={(e) => onChange(e.target.value)} />
