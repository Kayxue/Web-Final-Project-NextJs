...
export default function InputValue({ pushValueStr, setPushValueStr, setPushInputHidden, push }: prop) {
    ...
    return (
        <div className="input" style={{ background:"transparent" }}>
            <input type="number" id="stackSize" placeholder="請輸入1~10之間的數字" value={pushValueStr} onChange={(e) => onChange(e.target.value)} />
